...
# knitrSet and spar functions may be found in
# http://biostat.mc.vanderbilt.edu/wiki/pub/Main/RConfiguration/Rprofile
...
difference in means using as standar0  244728   8284   4772 S   0.3  0.2  48:27.28 panel-32-w+ 
22486 harrelfe  20   d error the square root of the sum
...
dReport(sex + race + smoking ~ trx, groups='trx', data=base,
        popts=list(layout=c(1, 3), key=list(space='left')),
        h=4, w=3.5)
